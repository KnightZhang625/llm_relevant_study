...
os.environ["WANDB_NAME"] = "grpo-qwen-2.5-3b-instruct-run-6"  # set the specific run name
...
class ScriptArguments:
    data_id_or_path: str = "/home/jiaxijzhang/llm_relevant_study/rl/grpo/datasets/Qwen2.5-3B-Instruct-Countdown-Tasks-3to4"
...
def grpo_function(
    ...
    # Load datasets
    ###############
    dataset = load_dataset(script_args.data_id_or_path, split="train")
